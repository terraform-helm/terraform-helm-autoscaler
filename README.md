...
|------|-------------|------|---------|:--------:|
| <a name="input_chart"></a> [chart](#input\_chart) | Chart of helm release | `string` | `"cluster-autoscaler"` | no |
...
| <a name="input_name"></a> [name](#input\_name) | Name of helm release | `string` | `"cluster-autoscaler"` | no |
...
| <a name="input_repository"></a> [repository](#input\_repository) | Url of repository | `string` | `"https://kubernetes.github.io/autoscaler"` | no |
